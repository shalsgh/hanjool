...
class QuoteStore: ObservableObject {
    ...
    init() {
        ...
        Quote(contents: "말은 한 사람의 입에서\n나와 천 사람의 귀로 들어간다.", author: "플라톤"),
        ...
        Quote(contents: "내가 가진 돈에\n대해 이야기하지 마라.", author: "플라톤"),
    ...
    // - 세네카 (6)
        ...
        Quote(contents: "신은 지식 그 자체를\n인간에게 주지 않고\n지식의 씨앗을 우리에게 주었다.", author: "세네카"),
        Quote(contents: "인생은\n짧은 이야기와 같다.\n중요한 것은\n그 길이가 아니라,\n가치다.", author: "세네카"),
        ...
        Quote(contents: "때로는 사는 것조차\n용기 있는 행동이다.", author: "세네카"),
        Quote(contents: "모든 잔인함은\n나약함에서 나온다.", author: "세네카"),


        
    // - 탈레스 (6)
        Quote(contents: "게으른 자가\n되지 말라.\n부자가 된다 하더라도\n게으르지 말라.", author: "탈레스"  ),
        Quote(contents: "\'겉모습\'에 멋부리지 말고,\n\'행함\'에서 멋있는 자가 되라.", author: "탈레스"),
    ...
    // - 키케로 (4)
        ...
        Quote(contents: "영혼의 병은 육체의 그것보다도 위험하고 무섭다.", author: "키케로"),
    ...
    // - 블레즈 파스칼 (0)
        ...
        Quote(contents: "일생에\n가장 중요한 것은\n직업의 선택이다.\n그런데 그것을 좌우하는 것은 우연이다.", author: "블레즈 파스칼"),
    ...
    // - 발타자르 그라시안 (19)
        ...
        Quote(contents: "강인한 육체는 무용담을 만들고,\n뛰어난 영혼은 예술을 낳는다.", author: "발타자르 그라시안"),
...
// ## 근현대 철학 (45)
    ...
    // - 괴테 (14)
        ...
        Quote(contents: "생각은 쉽고\n행동은 어렵다.\n생각을 행동으로 옮기는 일은\n세상에서 가장 어려운 일이다.", author: "요한 볼프강 폰 괴테"),
        Quote(contents: "하늘은 어디에서나\n푸르다는 사실을 알기 위해서\n세계 일주 여행을 할 필요는 없다.", author: "요한 볼프강 폰 괴테"),
        Quote(contents: "항상 바람직한 목적을\n잃지 않고 노력하는 한,\n최후에는 반드시 구함을 받는다.", author: "요한 볼프강 폰 괴테"),
        ...
        Quote(contents: "불가능한 일을 원하는 사람을 나는 사랑한다.", author: "요한 볼프강 폰 괴테"),
        Quote(contents: "바보는 결코 걱정하지 않는다.", author: "괴테"),
    ...
    // - 쇼펜하우어 (12)
        ...
        Quote(contents: "사람들은 책을 샀다는 것만으로\n그 책이 자기 것이라고 착각한다.", author: "아르투아 쇼펜하우어"),
        Quote(contents: "가장 멋진 생각은\n적어두지 않으면\n까맣게 잊힐 위험성이 있다.", author: "아르투르 쇼펜하우어"),
        Quote(contents: "흘러가는 시간은\n권태에 사로잡힌 자들을 벌한다.", author: "아르투어 쇼펜하우어"),
    ...
    // - 단테 (8)
        ...
        Quote(contents: "한번도\n실패하지 않는 것이 아니라,\n실패할 때 마다\n일어서는 것을\n목표로 하라.", author: "단테"),
        Quote(contents: "올바른 길을 벗어나서 걷다 보면,\n문득 눈을 떴을 때\n위험한 숲속일 것이다.", author: "단테"),
    ...
    // - 데카르트 (9)
        ...
        Quote(contents: "세상을 정복하려 하기 보다\n자기 자신을 먼저 정복하라.", author: "르네 데카르트"),
    ...
    // - 니체 (9)
        ...
        Quote(contents: "어느 정도\n깊이 괴로워하느냐 하는 것이\n거의 인간의 위계를 결정한다.", author: "프리드리히 니체"),
...
// ## 20세기 이후 철학 (26)
    // 놈 촘스키 (0)
        Quote(contents: "우리는 영웅을 찾는 것이 아니라\n좋은 아이디어를 찾아야 합니다.", author: "놈 촘스키"),
    // 마르틴 하이데거 (0)
        Quote(contents: "인간과 공간의 관계는\n다름 아닌 주거이며,\n주로 거주하는 곳이 아니라\n번성하고 돌아보는 공간이다.", author: "마르틴 하이데거"),
        Quote(contents: "기본적인 질문은\n\'우리가 무엇을 하는가?\'\n가 아니라\n\'우리가 무엇인가?\'이다.", author: "마르틴 하이데거"),
        ...
        Quote(contents: "우리는\n자신의 내면에 공간을 만들어\n존재가 말할 수 있도록 해야한다.", author: "마르틴 하이데거"),
        ...
        Quote(contents: "생각하는 것은\n우리 자신과 우리 자신의 조용한 대화이다.", author: "마르틴 하이데거"),
        Quote(contents: "인간은\n경이로움을 느낄 수 있는\n능력을 가진 존재이다.", author: "마르틴 하이데거"),
        Quote(contents: "불안이란\n존재의 무를 인식할 수 있는 가능성이다.", author: "마르틴 하이데거"),
        Quote(contents: "생각은\n존재의 고요한 깊이 있는 목소리이다.", author: "마르틴 하이데거"),
    ...
    // 존 듀이(0)
        ...
        Quote(contents: "우리는 문제에\n봉착했을 때에만 생각을 한다.", author: "존 듀이"),
    ...
    // - 버트런드 러셀 (2)
        ...
        Quote(contents: "지혜로워지는 첫걸음은\n\'두려움\'을 정복하는 것이다.", author: "버트런드 러셀"),
        Quote(contents: "모든 인간 활동은\n욕망에 의해 고무된다.", author: "버트런드 러셀"),
...
// MARK: - 동양철학 (35)
    ...
    // - 장자 (3)
        Quote(contents: "자신의\n\'어리석음\'을 아는 자는\n진정으로\n\'어리석은 자\'가 아니다.", author: "장자"),
        Quote(contents: "\'길\'이란\n걸어가면서\n만들어지는 것이다.", author: "장자"),
        Quote(contents: "정말 알면 모른다는 소리가 나온다.", author: "장자"),
    ...
    // - 묵자 (4)
        ...
        Quote(contents: "남을 그르다고 하는 사람은\n반드시 그것에 대신할 것을\n갖추고 있어야 한다.", author: "묵자"),
        Quote(contents: "군자는\n소인과 친구는 되지 않더라도\n소인을 대처하고 피할 줄 알아야 한다.", author: "묵자"),
        Quote(contents: "지혜로운 이는\n빛을 감추고\n우둔함을 보인다고 했다.", author: "묵자"),
    // - 순자 (3)
        Quote(contents: "\'유능\'하면 천하가\n나를 찾을 것이요, \'무능\'하면 천하가\n나를 버릴 것이다.", author: "순자"),
        Quote(contents: "길이 가깝다고 해도\n가지 않으면 도달하지 못하며,\n일이 작다고 해도\n행하지 않으면 성취되지 않는다.", author: "순자"),
    ...
    // - 조조 (0)
        ...
        Quote(contents: "죽고 사는 것은 하늘에 달렸으니\n이를 걱정함은 어리석은 일이다.", author: "조조"),
    ...
    // - 오다 노부나가 (1)
        ...
        Quote(contents: "자기가 사랑하는 일을 하고\n일을 위하여 일하라,\n그러면 나머지 것들은\n저절로 따라 올 것이다.", author: "오다 노부나가"),
        
        Quote(contents: "수동적으로 일하게 되면 능동적으로 일하는 경우보다 책임감이나 향상심이 떨어진다.", author: "오다 노부나가"),
   
    // - 장영실 (1)
        Quote(contents: "내가 남을 알지 못하는 것이\n죄일 뿐이다.\n남이 나를 알아주지 않는 게\n무슨 죄란 말인가.", author: "장영실"),

    // ## 근대 철학 (1)
        
    // - 안중근 (1)
        Quote(contents: "세월을 헛되이 보내지 마라, 청춘은 다시 돌아오지 않는다.", author: "안중근"),
        Quote(contents: "먼 곳을 향하는 생각이 없다면, 큰 일을 이루기 어렵다.", author: "안중근"),
        Quote(contents: "하루라도 글을 읽지 않으면 입안에 가시가 돋는다.", author: "안중근"),
...
// MARK: - 불교철학 (14)
    // - 석가모니 (14)
        Quote(contents: "다른 사람과 나를 비교하지 말라. 태양과 달을 비교할 수 없듯이 사람들은\n모두 각자의 시간에 빛난다.", author: "석가모니"),
        ...
        Quote(contents: "우리 인생의 최고 목표는 다른 사람들을 돕는 것이다.", author: "석가모니"),
...
// MARK: - 기업가 (52)
    ...
    // 제프 베조스 (0)
        ...
        Quote(contents: "비판받는 것을 두려워한다면\n그냥 아무것도 하지 않으면 된다.", author: "제프 베조스"),
    ...
    // 이나모리 가즈오 (9)
        ...
        Quote(contents: "이익은\n추구되는 것이 아니라\n노력 뒤에 오는 결과이다.", author: "이나모리 가즈오"),
        Quote(contents: "경영자는 자신을 희생하는 용기를 가져야 한다.", author: "이나모리 가즈오"),
    ...
    // 마윈 (4)
        Quote(contents: "\'바보\'들은\n입으로 말하고.\n\'똑똑한 사람\'은\n머리로 말하고,\n\'현명한 사람\'은 심장으로 말합니다.", author: "마윈"),
        Quote(contents: "세상은\n\'당신이 한 말\'은\n기억하지 않습니다.\n그러나\n\'당신이 이룬 것\'은\n기억합니다.", author: "마윈"),
        Quote(contents: "누구도\n볼 수 없는 기회가\n\'진짜 기회\'입니다.", author: "마윈"),
        Quote(contents: "당신의 \'태도\'는\n당신의 능력보다\n중요합니다.", author: "마윈"),
    // 기타 (1)
...
// MARK: - 작가/시인/화가/예술가 (38)
    ...
    // 조지 고든 바이런 (0)
        ...
        Quote(contents: "내 자신의 무식을 아는 것은 지식으로의 첫걸음이다.", author: "조지 고든 바이런"),
    ...
    // 새뮤얼 존슨 (0)
        ...
        Quote(contents: "여행에서\n지식을 얻어 돌아오고 싶다면\n떠날 때 지식을 몸에 지니고 가야 한다.", author: "새뮤얼 존슨"),
        Quote(contents: "불행을 늘어놓는 인간에게\n주어지는 것은\n연민보다는\n오히려 경멸이다.", author: "새뮤얼 존슨"),
    ...
    // 마크 트웨인 (14)
        ...
        Quote(contents: "우리는 모두 시궁창에 있지만\n우리 중 일부는\n별을 보고 있습니다.", author: "마크 트웨인"),
    ...
    // 셰익스피어 (6)
        Quote(contents: "\'겁쟁이\'는\n죽음에 앞서 몇 번이고 죽지만\n\'용감한 사람\'은\n한 번밖에 죽음을 맛보지 않는다.", author: "셰익스피어"),
        ...
        Quote(contents: "즐거운 활동은\n시간을 짧은 것처럼 보이게 한다.", author: "셰익스피어"),
        Quote(contents: "지식은\n우리가 하늘을 나는\n날개이다.", author: "셰익스피어"),
    ...
    // 카프카 (5)
        ...
        Quote(contents: "삶의 의미는 그것이 끝난다는 것이다.", author: "프란츠 카프카"),

    // 랄프 왈도 에머슨 (5)
        Quote(contents: "당신이 될 것으로\n정해진 유일한 사람은\n당신이 되고자\n\'결정한 사람\'이다. ", author: "랠프 월도 에머슨"),
    ...
    // 빅토르 위고 (3)
        ...
        Quote(contents: "노력을 중단하면 습관을 잃는다. 좋은 습관을 버리기는 쉽지만 다시 길들이기는 어려운 법이다.", author: "빅토르 위고"),
    ...
    // 헬렌 켈러 (1)
        Quote(contents: "자신의 약점에서부터\n인내력과 부드러운 마음과\n사물을 꿰뚫어 보는 힘을 배워야 한다.", author: "헬렌 켈러"),
...
// MARK: - 정치인 (7)
    ...
    // 윈스턴 처칠 (2)
        ...
        Quote(contents: "위험이 다가왔을 때\n도망치려고 생각해서는 안 됩니다.\n그렇게 되면 도리어 위험이 배가 됩니다.", author: "윈스턴 처칠"),
        ...
        Quote(contents: "비판이란 것이\n별로 달가울 것이 아닐지 모르지만\n경우에 따라서는 꼭 필요한 것입니다.", author: "윈스턴 처칠"),
...
// MARK: - 과학자 (15)
    // 아인슈타인 (7)
        ...
        Quote(contents: "상상력은\n지식보다 훨씬 중요하다.", author: "알베르트 아인슈타인"),
    ...
    // - 존 우든  (6)
        ...
        Quote(contents: "당신이 인간으로서 어떠한지가\n농구선수로서 어떠한가보다\n훨씬 더 중요하다.", author: "존 우든"),
    ...
    // - 무하마드 알리 (4)
        ...
        Quote(contents: "가장 위대한 사람도\n한 때는 초보였다.\n그 \'첫걸음\'을 내딛는 걸 두려워하지 마라.", author: "무하마드 알리"),
...
// MARK: - 책/만화/소설/영화 (30)
    // 탈무드 (7)
        ...
        Quote(contents: "우리는 어릴때부터 \'말하기\'를 배운다,\n하지만\n\'입을 다무는 방법\'에 대해서는 교육 받지 못했다.", author: "⌜탈무드 中⌟"),
        ...
        Quote(contents: "그 사람 입장에 서기 전에는\n절대로 그 사람을 욕하거나 책망하지 말라.", author: "『탈무드 中』"),
...
// MARK: - 인강 강사 (4)
    ...
    // MARK: - 기타 (0)
        ...
        Quote(contents: "하루 중 가장 먼저 하는 일이\n가장 영향력이 큰 일이다.\n왜냐하면\n그것이\n나머지 하루에 대한\n당신의 마음 가짐과 환경을 설정하기 때문이다.", author: "에번 페이건"),
        Quote(contents: "실행이 곧 전부다. 아이디어는 과제 극복의 5%에 불과하다. 아이디어의 좋고 나쁨은 어떻게 실행하느냐에 따라 결정된다고 해도 과언이 아니다.", author: "카를로스 곤"),
        ...
        Quote(contents: "시간은 위대한 스승이다.\n누가 희망 없이 살 수 있는가?\n어둠 속에서 슬픔의 큰 다발을 가지고 사람들이 행진한다.", author: "C. 샌드버그"),
        ...
        Quote(contents: "현재를 향락하라.\n내일 일은\n그다지 믿을 바가 못 된다.", author: "호라티우스"),
        Quote(contents: "노력해서 해결 될수 없을 만큼 어려운 일은 아무 것도 없다.", author: "테렌티우스"),
        ...
        Quote(contents: "언어는 대지의 딸이다. 그러나, 행위는 하늘의 아들이다.", author: "H. 존즈"),
        Quote(contents: "재상(宰相)이 되는 자격 중\n가장 중요한 것은 인내이다.", author: "W. 비트"),
        Quote(contents: "행복이라는\n상어는\n소심한 자의\n그물에는\n안 걸린다.", author: "핀란드 격언"),
        ...
        Quote(contents: "행위를 수반하지 않는 지식은\n꿀이 없는 꿀벌과 같다.", author: "헤르더"),
        ...
        Quote(contents: "유행은\n어리석은 자를 위해서 있다.", author: "R. 도즐리"),
        Quote(contents: "우리 생활에\n유익하면\n그것이 진리이다.", author: "제임스"),
        Quote(contents: "신용을 잃는 것은\n가장 큰 손해다.", author: "J. 클라크"),
        Quote(contents: "스스로 도울 수 없는 사람들 도와라.", author: "콩고 격언"),
        Quote(contents: "일하라!\n더욱 일하라!\n항상 일하라!", author: "강베타"),
        ...
        Quote(contents: "널리 배우는 방법이 많지만 독서하는 것만큼 좋은 것이 없다.", author: "가이바라 에키켄"),
        ...
        Quote(contents: "보다 큰 악이 닥쳐오지 않게 하려면 현재의 악을 굴복시키라.", author: "파에두루스"),
        ...
        Quote(contents: "내가 먹은 음식이\n곧 나를 말한다.\n몸을 잘 돌보면\n몸이 나를 잘 도봐줄 것이다.", author: "할 엘로드"),
        Quote(contents: "가장 중요한 건\n인생을 즐기는 것,\n행복해지는 것이다.\n그것이 중요한 전부다.", author: "오드리 헵번"),
        Quote(contents: "운동할 시간을 내지\n못하는 사람들은\n아마도 앓는 데\n시간을 쓰게 될 것이다.", author: "로빈 샤르마"),
        Quote(contents: "당신을\n시작하게 하는 것은 의욕이다.\n그리고 의욕을 지속시키는 것은\n습관이다.", author: "짐 론"),
        Quote(contents: "오늘부터\n운동을 한다고 생각하지 말고,\n새로운 삶을\n산다고 생각해야 한다.", author: "김종국"),
        Quote(contents: "슬픔은 한순간의 고통이다. 슬픔에 잠기는 것은 인생의 큰 실수이다.", author: "벤저민 디즈레일리"),
        Quote(contents: "이기는 것이 다가 아니다.\n이기는 것을 원하는 것이 중요하다.", author: "빈스 롬바디"),
        ...
        Quote(contents: "행운은 소심한 자의 편이 아니다.", author: "그리스 격언"),
        ...
        Quote(contents: "인생은 곱셈과 같다. 기회가 오더라도 내가 제로이면 아무런 의미가 없다.", author: "나카무라 미츠루"),
        ...
        Quote(contents: "지혜로운 사람은 수많은 성취를 이룩하고도 기꺼이 더 배우려고 한다.", author: "에드 파커"),
        ...
        Quote(contents: "과거의 탓, 남의 탓이라는 생각을 버릴 때 인생은 호전한다.", author: "웨인 다이어"),
        Quote(contents: "특별한 삶은 매일 끊임없이 개선을 통해 만들어지는 것이다.", author: "로빈 샤르마"),
        ...
        Quote(contents: "다른 사람이 한 번 읽어서 알면\n나는 백 번을 읽고,\n다른 사람이 열 번 읽어서 알면\n나는 천 번을 읽는다.", author: "주자"),
        ...
        Quote(contents: "천국일지라도 혼자서 살려면 견디기 힘들 것이다.", author: "러시아 속담"),
        Quote(contents: "사소한 일을 소홀히 하는 자는 사소한 일로 멸망한다.", author: "솔로몬"),
        Quote(contents: "미덕은 서로 합치가 되지만 악덕은 서로 싸운다.", author: "T. 폴러"),
        ...
        Quote(contents: "고독 없이는 아무것도 달성할 수 없다. 나는 예전에 나를 위해 일종의 고독을 만들었다.", author: "피카소"),
        Quote(contents: "슬픈 마음이여,\n침착하고 탄식을 멈추라.\n구름 뒤엔 아직도\n햇빛이 빛나고 있다.", author: "롱펠로우"),
        Quote(contents: "자신의 고뇌를\n세밀하게 살펴 보는 것이야 말로\n자신의 마음을 위로하는 수단이다.", author: "스탕달"),
        ...
        Quote(contents: "가시에 찔리지 않고서는 장미꽃을 모을 수가 없다.", author: "필페이"),
        Quote(contents: "책보다 인간을 공부하는 것이 더 필요하다.", author: "라 로시푸코"),
        ...
        Quote(contents: "아침에 도를 익히면 저녁에 죽어도 좋다.", author: "공자"),
        Quote(contents: "간소한 생활, 그리고 높은 사색", author: "워즈워드"),
        ...
        Quote(contents: "아무도 해 보기 전에는 자기가 무엇을 할 수 있을지 모른다.", author: "시루스"),
        Quote(contents: "나에게 돈이 갖는 의미는\n성취에 대한 자부심입니다.", author: "레이 크로크"),
        Quote(contents: "시간을 이용할 줄 아는 사람은 하루를 사흘로 통한다.", author: "영국 격언"),
        Quote(contents: "내일 무엇을 해야 할지\n모르는 사람은 불행하다.", author: "고리키"),
        Quote(contents: "하루종일 일하는 사람은\n돈 벌 시간이 없다.", author: "존 록펠러"),
        Quote(contents: "기적은\n그것을 믿는 자에게만 일어난다.", author: "프랑스 격언"),
        Quote(contents: "이성이 잠들면 괴물이 눈을 뜬다.", author: "프란시스코 고야"),
        Quote(contents: "자신을 아는 일이 곧 신을 아는 일이다.", author: "무함마드"),
        Quote(contents: "투자의 성공은 원칙이 결정한다.", author: "박영옥"),
        ...
        Quote(contents: "언제나 겸손한 사람은\n남에게 칭찬을 들었을 때나\n험담을 들었을 때나 변함이 없다.", author: "장 파울"),
        Quote(contents: "나이를 먹고\n세월이 흐르면\n시간이 없기 때문에\n자기가 좋아하는 일부터\n먼저 해라.", author: "이어령"),
        Quote(contents: "넘어지는 횟수보다 일어나는 횟수가 한 번 더 많을 때 성공할 수 있다.", author: "올리버 골드스미스"),
        ...
        Quote(contents: "성공이란\n그 결과로 측정되기보다는\n그것에 소비한 노력의\n총계로 따져야 할 것이다.", author: "토마스 에디슨"),
        Quote(contents: "작은 일을 할 때도\n큰 그림을 그리며 실행하라\n그래야 올바른 방향을 갈 수 있다.", author: "앨빈 토플러"),
        Quote(contents: "우리는\n태어나서 죽을 때까지\n매일 한 페이지 한 페이지를\n창작해 간다.", author: "모리스 메테르링크"),
        Quote(contents: "독서는\n작가의 지혜가 끝나는 곳에서\n우리의 지혜가 시작되는 행위다.", author: "마르셀 프루스트"),
        Quote(contents: "살아있는 동안\n위대했던 사람은\n죽은 뒤에는 두배나 위대해 진다.", author: "토마스 칼라일"),
        Quote(contents: "서로 작은 결점을 용서할 마음이 없고선 온전한 우애를 이룰 수 없다.", author: "라브뤼예르"),
        Quote(contents: "인간은 행복하지 않다.\n그러나 항상 미래의 행복을 기대하는 존재다.", author: "A. 포프"),
        Quote(contents: "불운만큼\n우리의 영혼에 자극을 주고\n수확을 가져다주는 것도 없다.", author: "H. 헤세"),
        Quote(contents: "현자의 목표는 환락의 획득에 있지 않고 고통의 회피에 있다.", author: "아리스토텔레스"),
        ...
        Quote(contents: "모든 위대한 성과는\n현실 이전에 비전이었다.", author: "헨리 키신저"),
        Quote(contents: "인간은 이웃이 돈을 쌓는 것을 부러워 한다.", author: "헤시오도스"),
        Quote(contents: "사랑이 충족되면\n그 매력은 모두 사라진다.", author: "코르네이유"),
        Quote(contents: "밤이 어두울 때에\n더 많은 별을 본다.", author: "토마스 에디슨"),
        Quote(contents: "고통은 잠시지만 포기는 평생입니다.", author: "파울로 코엘료"),
        Quote(contents: "한 가지 일이 늦어지면 만사가 늦어진다.", author: "H. 게도"),
        Quote(contents: "좋은 책은 인류에게 불멸의 정신이다.", author: "존 밀턴"),
        Quote(contents: "내 그리운 추억은 바위보다 무겁다.", author: "보들레르"),
        ...
        Quote(contents: "문명인은 철도 객차를 만들어 내었으나, 자기의 두 다리를 못쓰게 했다.", author: "에머슨"),
